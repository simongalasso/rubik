...
fn main() {
    ...
    cb_cube.set_c_p_coord(12);
    println!("c_p_coord: {}",  cb_cube.get_c_p_coord());
    cb_cube.set_c_p_coord(28);
    println!("c_p_coord: {}",  cb_cube.get_c_p_coord());
    cb_cube.set_c_p_coord(72);
    println!("c_p_coord: {}",  cb_cube.get_c_p_coord());
    cb_cube.set_c_p_coord(96);
    println!("c_p_coord: {}",  cb_cube.get_c_p_coord());
    cb_cube.set_c_p_coord(40319);
    println!("c_p_coord: {}",  cb_cube.get_c_p_coord());
    cb_cube.set_c_p_coord(0);
    println!("c_p_coord: {}",  cb_cube.get_c_p_coord());
